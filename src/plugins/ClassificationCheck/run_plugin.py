"""
This script is called by the plugin-wrapper, ClassificationCheck.js, which passes down the
...
from ClassificationCheck import ClassificationCheck
...
plugin = ClassificationCheck(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
